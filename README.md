...
## Data files (`tippspiel/data/`)

| File | Contents |
|---|---|
| `teams.csv` | 48 teams: `team_id, name, elo, elo_trend` |
| `fixtures.csv` | all 104 matches (72 group with concrete teams, 32 knockout with placeholders) |
| `results.csv` | played matches (initially empty; append rows as the tournament runs) |
| `r32_bracket_map.json` | R32 pairing structure + third-placed allocation |
